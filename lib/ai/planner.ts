...
{
  "config": { "name": string, "hosting": string, "database"?: string },
  "steps": [{ "id": string, "name": string, "provider": string }]
}
Steps must be concrete provisioning/deployment actions in execution order. Providers are lowercase slugs like "github", "vercel", "supabase", "cloudflare".`;
